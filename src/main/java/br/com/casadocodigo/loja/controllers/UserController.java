...
public class UserController {
	...
	public ModelAndView gravar(@Valid Usuario usuario, BindingResult result, RedirectAttributes model) {
	...
	public ModelAndView editar(@PathVariable("id") String email) {
		...
		List<Role> roleList = roleDao.listar();
	...
	public ModelAndView updateRoles(@ModelAttribute Usuario usuario, RedirectAttributes model) {
